  ...
  return (
    <>
      ...
      <section className="mb-12">
        <div className="bg-gradient-to-br from-slate-900 via-emerald-900/80 to-black rounded-lg p-8 text-white shadow-2xl">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 text-center">
            ...
            <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">小鱼·币币机 | Croath</h3>
            <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">8年区块链从业者 | 产品研发 | 经济模型设计</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <h3 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">关于频道</h3>
          ...
          {/* 统计信息 */}
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <h3 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">频道数据</h3>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">📺 全部视频</h2>
            <div className="grid gap-6">
              {videos.length === 0 ? (
                ...
                >
                  <div className="flex gap-4 p-4 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-500 hover:shadow-md dark:hover:shadow-lg transition-all bg-white dark:bg-gray-800">
